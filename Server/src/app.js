...
app.use((req, res, next) => {
      res.setHeader(
        ...
        "default-src 'self' blob: https://35.197.156.82:8090 http://localhost:8090; img-src 'self' data: https://35.197.156.82:8090 http://localhost:8090; style-src 'self' 'unsafe-inline';"
      );
