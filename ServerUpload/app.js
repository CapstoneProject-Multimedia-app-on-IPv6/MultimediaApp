...
app.use((req, res, next) => {
  res.setHeader(
    ...
    "default-src 'self' blob: http://35.240.234.86:8089 http://localhost:8090; " +
    "script-src 'self' https://unpkg.com; " + 
    "style-src 'self' 'unsafe-inline' https://fonts.googleapis.com/; " + 
    "img-src 'self' data: http://35.240.234.86:8089 http://localhost:8090; " +
    "media-src 'self' data: http://35.240.234.86:8089 http://localhost:8090; " +
